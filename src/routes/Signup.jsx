...
setepassword("")
  ...
  return (
    ...
    <div className='max-w-[400px] mx-auto min-h-[600px] px-4 b py-20 '>
      ...
      {error ? <p className='bg-red-600 p-3 my-2 text-white'>{error}</p>  : null}
      ...
      <p className='my-4 '>Already have an account? <Link to="/signin" className='text-accent font-bold'>Sign In</Link></p>
    </div>
  </div>
  )
}
